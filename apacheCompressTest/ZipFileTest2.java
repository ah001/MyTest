...
public class ZipFileTest2 {
	...
	public static void main(String argv[]) throws Exception {
        ...
        File destination = new File("C:\\USWC_Deploy\\3_USWC_PA\\PA_Patch\\testTOSPro.zip");
        destination.delete();
        
        ZipFileTest2 zt = new ZipFileTest2();
        
        zt.addFilesToZip(source, destination);
    ...
    private void assertZipContent(File destination) throws IOException {
        ...
        //ssertThat(numberOfEntries, is(1));
    }
}